...
// source: src/rpc/rpcheader.proto

#include "src/rpc/rpcheader.pb.h"
...
static void InitDefaultsscc_info_RpcHeader_src_2frpc_2frpcheader_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RpcHeader_src_2frpc_2frpcheader_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RpcHeader_src_2frpc_2frpcheader_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_src_2frpc_2frpcheader_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_src_2frpc_2frpcheader_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_src_2frpc_2frpcheader_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_src_2frpc_2frpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::RPC::RpcHeader, compressed_),
  PROTOBUF_FIELD_OFFSET(::RPC::RpcHeader, original_size_),
  PROTOBUF_FIELD_OFFSET(::RPC::RpcHeader, compression_type_),
};
...
const char descriptor_table_protodef_src_2frpc_2frpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\027src/rpc/rpcheader.proto\022\003RPC\"\216\001\n\tRpcHe"
  "ader\022\024\n\014service_name\030\001 \001(\014\022\023\n\013method_nam"
  "e\030\002 \001(\014\022\021\n\targs_size\030\003 \001(\r\022\022\n\ncompressed"
  "\030\004 \001(\010\022\025\n\roriginal_size\030\005 \001(\r\022\030\n\020compres"
  "sion_type\030\006 \001(\rb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_src_2frpc_2frpcheader_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_src_2frpc_2frpcheader_2eproto_sccs[1] = {
  &scc_info_RpcHeader_src_2frpc_2frpcheader_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_src_2frpc_2frpcheader_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_src_2frpc_2frpcheader_2eproto = {
  false, false, descriptor_table_protodef_src_2frpc_2frpcheader_2eproto, "src/rpc/rpcheader.proto", 183,
  &descriptor_table_src_2frpc_2frpcheader_2eproto_once, descriptor_table_src_2frpc_2frpcheader_2eproto_sccs, descriptor_table_src_2frpc_2frpcheader_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_src_2frpc_2frpcheader_2eproto::offsets,
  file_level_metadata_src_2frpc_2frpcheader_2eproto, 1, file_level_enum_descriptors_src_2frpc_2frpcheader_2eproto, file_level_service_descriptors_src_2frpc_2frpcheader_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_src_2frpc_2frpcheader_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_src_2frpc_2frpcheader_2eproto)), true);
namespace RPC {
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  ::memcpy(&args_size_, &from.args_size_,
    ...
    reinterpret_cast<char*>(&args_size_)) + sizeof(compression_type_));
  // @@protoc_insertion_point(copy_constructor:RPC.RpcHeader)
}

void RpcHeader::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RpcHeader_src_2frpc_2frpcheader_2eproto.base);
  service_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  method_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 5:
        ...
        continue;
      // uint32 compression_type = 6;
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          compression_type_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  if (this->compression_type() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(6, this->_internal_compression_type(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:RPC.RpcHeader)
  ...
  if (from.original_size() != 0) {
    _internal_set_original_size(from._internal_original_size());
  }
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RpcHeader, compression_type_)
      + sizeof(RpcHeader::compression_type_)
